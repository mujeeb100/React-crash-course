<template>
  <div>
    <!--Partnership bussiness Pan upload  -->
    ...
    <div v-if="hideshowFields.panDiv == 1" class="p-3 mt-3 border rounded-lg">
      ...
      <div v-if="hideshowFields.panDiv === 1">
        <div class="flex-row" style="gap: 3rem"></div>
    ...
    <div v-if="hideshowFields.aadharOcr === 1" class="aadhar-div-start">
      ...
      <div class="flex-col">
        ...
        <div
          v-if="hideshowFields.panDiv == 1"
          class="p-3 mt-3 border rounded-lg"
        >
          <!-- style="border: 0.15rem solid gray; border-radius: 7px" -->

          <!-- <div class="mb-2 n-custom-file"> -->
          <!-- :value="innerformValue.pan" -->

          <!-- <input
          ref="fileinput"
          type="file"
          style="display: none"
          @change.prevent="panUpload"
         />
         <label
          data-browse="Browse"
         ...
         > -->
          ...
          <!-- <button style="display: none" @click="$refs.fileinput.click()">
        Upload
      </button> -->
          <!-- </div> -->
          <div ref="panEdit" class="flex-end mb-3">
          ...
          <div v-if="hideshowFields.panDiv === 1">
            ...
            <label>Gender</label>
            <select
              v-model="panFormFields.gender"
              :disabled="disabledFields.panDisabled == 1"
              class="custom-select"
            >
              <option selected :value="null" disabled>Choose the gender</option>
              <option v-for="(item, index) in genderOptions" :key="index">
                {{ item }}
              </option>
            </select>
          </div> -->
    ...
    <div class="mt-4">
      <b-form-checkbox
        ...
        @click="userSearchError"
      >
        I accept the
        <nuxt-link to="/niyogin/terms-condition" target="_blank">
          terms and conditions
        </nuxt-link>
        <b-alert v-if="userSearchError" show variant="danger"
          >Agree the terms & conditions first
        </b-alert>
      </b-form-checkbox>
    </div>
